...
// Создайте объект покупатель. Добавьте свойства имя, фамилия, адрес, телефон.
// Сделайте так, чтобы пользователь могу изменить одним вызовом свойства адрес и 
// телефон и запретите изменение свойств имя и фамилия. 
//  Создайте свойство вывода полной информации о пользователе.
...
const cystemer = {
    ...
    set editInfo(info){
        ...
        [this.adres, this.tel] = info.split(",");

    },
    get editInfo() {
        return 'name:' + this.name +'lastName:' + this.lastName + 'adres:' + this.adres + 'tel:' + this.tel
    }
    

};
Object.defineProperty(cystemer, "name",{
    writable : false
})
Object.defineProperty(cystemer, "lastName",{
    writable : false
})

cystemer.editInfo ='Rovno , 3452355';
